...
Core/lvgl/examples/libs/rlottie/%.o Core/lvgl/examples/libs/rlottie/%.su Core/lvgl/examples/libs/rlottie/%.cyclo: ../Core/lvgl/examples/libs/rlottie/%.c Core/lvgl/examples/libs/rlottie/subdir.mk
