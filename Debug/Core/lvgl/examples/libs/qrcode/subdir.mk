...
Core/lvgl/examples/libs/qrcode/%.o Core/lvgl/examples/libs/qrcode/%.su Core/lvgl/examples/libs/qrcode/%.cyclo: ../Core/lvgl/examples/libs/qrcode/%.c Core/lvgl/examples/libs/qrcode/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-libs-2f-qrcode:
	-$(RM) ./Core/lvgl/examples/libs/qrcode/lv_example_qrcode_1.cyclo ./Core/lvgl/examples/libs/qrcode/lv_example_qrcode_1.d ./Core/lvgl/examples/libs/qrcode/lv_example_qrcode_1.o ./Core/lvgl/examples/libs/qrcode/lv_example_qrcode_1.su
