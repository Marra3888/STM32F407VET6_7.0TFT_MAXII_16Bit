...
Core/lvgl/examples/libs/bmp/%.o Core/lvgl/examples/libs/bmp/%.su Core/lvgl/examples/libs/bmp/%.cyclo: ../Core/lvgl/examples/libs/bmp/%.c Core/lvgl/examples/libs/bmp/subdir.mk
...
clean-Core-2f-lvgl-2f-examples-2f-libs-2f-bmp:
	-$(RM) ./Core/lvgl/examples/libs/bmp/lv_example_bmp_1.cyclo ./Core/lvgl/examples/libs/bmp/lv_example_bmp_1.d ./Core/lvgl/examples/libs/bmp/lv_example_bmp_1.o ./Core/lvgl/examples/libs/bmp/lv_example_bmp_1.su
